...
GLfloat lightDiffuse[] = { 0.5019f, 0.0f , 0.2745f, 1.0f };
...
@implementation GLView
{
    ...
    GLuint lightDiffuseUniformF;
    GLuint lightAmbientUniformF;
    GLuint lightSpecularUniformF;
    ...
    GLuint materialDiffuseUniformF;
    GLuint materialAmbientUniformF;
    GLuint materialSpecularUniformF;
...
-(int)initialise
{
    ...
    //Get shader uniform locations
        ...
        lightAmbientUniform = glGetUniformLocation(shaderProgramObjectF, "uLightAmbient");
        lightDiffuseUniform = glGetUniformLocation(shaderProgramObjectF, "uLightDiffuse");
        lightSpecularUniform = glGetUniformLocation(shaderProgramObjectF, "uLightSpecular");
        lightPositionUniform = glGetUniformLocation(shaderProgramObjectF, "uLightPosition");
