...
const GLfloat pyramid_texcoords[] =
    ...
    glGenBuffers(1, &VBO_pyramid_positions);
    glBindBuffer(GL_ARRAY_BUFFER, VBO_pyramid_positions);
...
//Texcoords
    ...
    textureImageCube = [self loadGLTextures:@"Kundali" :@"bmp"];
