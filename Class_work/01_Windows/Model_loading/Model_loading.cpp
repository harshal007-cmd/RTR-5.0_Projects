...
int initialize(void)
{
	...
	pModel = new loadObjModel("C:\\Users\\Lenovo\\Desktop\\RTR\\RTR-5.0_Projects\\Class_work\\01_Windows\\Model_loading\\Cube.obj");
	fprintf(gpFILE, "Loading model sucessfull\n");
	//Enabling depth
