...
@implementation GLView
{
	...
	mat4 orthographicsProjectionMatrix;  //in vmath
...
-(int)initialise
{
	...
	orthographicsProjectionMatrix = vmath::mat4::identity();
...
-(GLuint)loadGLTextures:(const char*)imageFileName
{
    ...
    CFDataProviderRef imageDataRef = CGDataProviderCopyData(CGImageGetDataProvider(CGImage));
...
-(void)resize:(int)width :(int)height
{
	...
	//set orthogrpahics projection matrix
	if (width <= height)
	{
...
-(void)Display
{
	...
	mat4 modelViewProjectionMatrix = orthographicsProjectionMatrix * modelViewMatrix;
